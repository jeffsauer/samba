[![logo](https://raw.githubusercontent.com/jeffsauer/samba/master/logo.jpg)](https://www.samba.org)

# Samba

A fresh and updated Samba docker container based on dperson/samba
...
## Hosting a Samba instance
    ...
    sudo docker run -it -p 139:139 -p 445:445 -d jsauer/samba -p
...
## Configuration
    ...
    sudo docker run -it --rm jsauer/samba -h
...
### Setting the Timezone
    ...
    sudo docker run -it -e TZ=EST5EDT -p 139:139 -p 445:445 -d jsauer/samba -p
...
through a [GitHub issue](https://github.com/jeffsauer/samba/issues).